...
@keyframes glitch-anim {
  ...
  10% { clip: rect(24px, 9999px, 48px, 0); transform: skew(0.5deg); }
  15% { clip: rect(80px, 9999px, 10px, 0); transform: skew(0.1deg); }
  100% { clip: rect(67px, 9999px, 81px, 0); transform: skew(0.1deg); }
}

@keyframes glitch-anim2 {
  0% { clip: rect(44px, 9999px, 56px, 0); transform: skew(0.3deg); }
  50% { clip: rect(12px, 9999px, 90px, 0); transform: skew(0.8deg); }
  100% { clip: rect(50px, 9999px, 30px, 0); transform: skew(0.2deg); }
}
