<template>
    ...
    >
        ...
        <g v-if="stone.interactions > 0">
            <circle
                v-for="j in Math.min(stone.interactions, 6)"
                :key="'int-' + j"
        ...
        >
            <el-tooltip placement="top" :show-after="200" :offset="20" effect="light" popper-class="zen-tooltip-popper">
                <template #content>
                    <div class="flex flex-col gap-3 min-w-[140px] max-w-[300px] p-3">
                        ...
                        <!-- 互动统计 -->
                        <div
                            v-if="stone.interactions > 0"
                            class="flex items-center gap-1 pt-1 text-[10px] text-white/30"
                        >
                            <span>✨</span>
