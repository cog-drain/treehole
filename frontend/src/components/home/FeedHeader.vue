    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-8">
        <div class="flex items-center gap-6">
            ...
            >
                ...
                <span
                    v-if="viewMode === mode"
                    class="absolute bottom-0 left-0 w-full h-0.5 bg-blue-500 shadow-[0_0_8px_rgba(59,130,246,0.5)]"
                ></span>
            </button>
        </div>
        <div
            class="inline-flex w-full sm:w-auto items-center justify-between sm:justify-start gap-3 rounded-full border border-slate-200 bg-white/60 px-3 py-2 text-slate-500 shadow-sm backdrop-blur-xl"
        >
