<template>
    <div ref="container" class="graph-3d-container">
        ...
        <MindGraphOverlay :show-links="showLinks" @reset="resetCamera" @toggle-links="toggleLinks" />
...
const { container, graphElement, loading, showLinks, resetCamera, toggleLinks } = useMindGraph3D(props, emit)
</script>
