            ...
            >
                <div class="flex justify-between items-start mb-4">
                    <div class="flex items-center gap-2">
                        <div class="w-8 h-8 rounded-xl bg-emerald-500/10 flex items-center justify-center text-lg">
                            ✉️
                        </div>
                        <div class="flex flex-col">
                            <span class="text-[10px] uppercase tracking-widest opacity-40 leading-none"
                                >My Message</span
                            >
                ...
                <div v-if="bottle.replyContent" class="relative mt-6 pt-6 border-t border-dashed border-black/10">
                    <div
                        class="absolute -top-3 left-1/2 -translate-x-1/2 bg-cyan-500 text-white text-[9px] font-bold px-3 py-1 rounded-full shadow-lg shadow-cyan-500/20"
                    >
                        REPLY RECEIVED
                    </div>
                    ...
                    <div class="flex items-center gap-2 mb-3">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-xs font-bold text-cyan-600">{{
                                bottle.replyAuthorAlias || '一位不愿透露姓名的路人'
                            }}</span>
                        </div>
                    </div>

                    <div
                        class="text-sm px-4 py-3 rounded-2xl bg-cyan-500/5 border border-cyan-500/10 text-cyan-900 leading-relaxed font-medium"
                    >
                        “ {{ bottle.replyContent }} ”
                    </div>
