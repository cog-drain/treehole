...
export const commentApi = {
    // 获取指定留言的评论列表
    getComments: (messageId: Id) =>
        request.get<unknown, ApiResponse<Comment[]>>('/comments', { params: { messageId } }),
    ...
    // 表情回应
    reactToComment: (id: Id, emoji: string) =>
        request.post<unknown, ApiResponse<unknown>>(`/comments/${id}/reactions`, null, { params: { emoji } })
}
